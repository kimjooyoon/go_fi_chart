...
type Repository interface {
	...
	// ReadOnlyRepository는 읽기 전용 작업을 위한 인터페이스입니다.
	repository.ReadOnlyRepository[*domain.Asset, string]
	
	// WriteOnlyRepository는 쓰기 전용 작업을 위한 인터페이스입니다.
	repository.WriteOnlyRepository[*domain.Asset, string]
